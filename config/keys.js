...
// The next 2 work only locally!!!!!!!!!!!!!!!! DB_PASS=dbUser123
...
// dbPassword = 'mongodb+srv://dbUser:'+ process.env.DB_PASS + '@cluster0-kg7ic.azure.mongodb.net/local_library_prod?retryWrites=true&w=majority';
